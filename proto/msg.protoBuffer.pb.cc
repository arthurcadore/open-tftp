...
// source: msg.protoBuffer

#include "msg.protoBuffer.pb.h"
...
static ::_pb::Metadata file_level_metadata_msg_2eprotoBuffer[10];
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_msg_2eprotoBuffer[2];
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_msg_2eprotoBuffer = nullptr;

const uint32_t TableStruct_msg_2eprotoBuffer::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const char descriptor_table_protodef_msg_2eprotoBuffer[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017msg.protoBuffer\022\005tftp2\"/\n\003REQ\022\r\n\005fname"
  "\030\001 \002(\t\022\031\n\004mode\030\002 \002(\0162\013.tftp2.Mode\"(\n\004DAT"
  "A\022\017\n\007message\030\001 \002(\014\022\017\n\007block_n\030\002 \002(\r\"\026\n\003A"
  "CK\022\017\n\007block_n\030\001 \002(\r\",\n\005Error\022#\n\terrorcod"
  "e\030\001 \002(\0162\020.tftp2.ErrorCode\"\024\n\004Path\022\014\n\004pat"
  "h\030\001 \002(\t\".\n\014ListResponse\022\036\n\005items\030\001 \003(\0132\017"
  ".tftp2.ListItem\"M\n\010ListItem\022\033\n\004file\030\001 \001("
  "\0132\013.tftp2.FILEH\000\022\032\n\003dir\030\002 \001(\0132\013.tftp2.Pa"
  "thH\000B\010\n\006answer\"%\n\004FILE\022\014\n\004nome\030\001 \002(\t\022\017\n\007"
  "tamanho\030\002 \002(\005\",\n\004MOVE\022\021\n\tnome_orig\030\001 \002(\t"
  "\022\021\n\tnome_novo\030\002 \001(\t\"\240\002\n\010Mensagem\022\031\n\003rrq\030"
  "\001 \001(\0132\n.tftp2.REQH\000\022\031\n\003wrq\030\002 \001(\0132\n.tftp2"
  ".REQH\000\022\033\n\004data\030\003 \001(\0132\013.tftp2.DATAH\000\022\031\n\003a"
  "ck\030\004 \001(\0132\n.tftp2.ACKH\000\022\035\n\005error\030\005 \001(\0132\014."
  "tftp2.ErrorH\000\022\033\n\004list\030\006 \001(\0132\013.tftp2.Path"
  "H\000\022(\n\tlist_resp\030\007 \001(\0132\023.tftp2.ListRespon"
  "seH\000\022\034\n\005mkdir\030\010 \001(\0132\013.tftp2.PathH\000\022\033\n\004mo"
  "ve\030\t \001(\0132\013.tftp2.MOVEH\000B\005\n\003msg*)\n\004Mode\022\014"
  "\n\010netascii\020\001\022\t\n\005octet\020\002\022\010\n\004mail\020\003*\231\001\n\tEr"
  ...
  "knownSession\020\007\022\r\n\tUndefined\020\010"
  ;
static ::_pbi::once_flag descriptor_table_msg_2eprotoBuffer_once;
const ::_pbi::DescriptorTable descriptor_table_msg_2eprotoBuffer = {
    false, false, 909, descriptor_table_protodef_msg_2eprotoBuffer,
    "msg.protoBuffer",
    &descriptor_table_msg_2eprotoBuffer_once, nullptr, 0, 10,
    schemas, file_default_instances, TableStruct_msg_2eprotoBuffer::offsets,
    file_level_metadata_msg_2eprotoBuffer, file_level_enum_descriptors_msg_2eprotoBuffer,
    file_level_service_descriptors_msg_2eprotoBuffer,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_msg_2eprotoBuffer_getter() {
  return &descriptor_table_msg_2eprotoBuffer;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_msg_2eprotoBuffer(&descriptor_table_msg_2eprotoBuffer);
namespace tftp2 {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Mode_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_msg_2eprotoBuffer);
  return file_level_enum_descriptors_msg_2eprotoBuffer[0];
}
...
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* ErrorCode_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_msg_2eprotoBuffer);
  return file_level_enum_descriptors_msg_2eprotoBuffer[1];
}
...
::PROTOBUF_NAMESPACE_ID::Metadata REQ::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_msg_2eprotoBuffer_getter, &descriptor_table_msg_2eprotoBuffer_once,
      file_level_metadata_msg_2eprotoBuffer[0]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata DATA::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_msg_2eprotoBuffer_getter, &descriptor_table_msg_2eprotoBuffer_once,
      file_level_metadata_msg_2eprotoBuffer[1]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata ACK::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_msg_2eprotoBuffer_getter, &descriptor_table_msg_2eprotoBuffer_once,
      file_level_metadata_msg_2eprotoBuffer[2]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Error::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_msg_2eprotoBuffer_getter, &descriptor_table_msg_2eprotoBuffer_once,
      file_level_metadata_msg_2eprotoBuffer[3]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Path::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_msg_2eprotoBuffer_getter, &descriptor_table_msg_2eprotoBuffer_once,
      file_level_metadata_msg_2eprotoBuffer[4]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata ListResponse::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_msg_2eprotoBuffer_getter, &descriptor_table_msg_2eprotoBuffer_once,
      file_level_metadata_msg_2eprotoBuffer[5]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata ListItem::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_msg_2eprotoBuffer_getter, &descriptor_table_msg_2eprotoBuffer_once,
      file_level_metadata_msg_2eprotoBuffer[6]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata FILE::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_msg_2eprotoBuffer_getter, &descriptor_table_msg_2eprotoBuffer_once,
      file_level_metadata_msg_2eprotoBuffer[7]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata MOVE::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_msg_2eprotoBuffer_getter, &descriptor_table_msg_2eprotoBuffer_once,
      file_level_metadata_msg_2eprotoBuffer[8]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Mensagem::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_msg_2eprotoBuffer_getter, &descriptor_table_msg_2eprotoBuffer_once,
      file_level_metadata_msg_2eprotoBuffer[9]);
}
